\section{Gradients of hysteretic neural networks with respect to inputs}\label{sec:chapter3:gradient-networks}
...
The derivation of $y_j$ with respect to $p_j$ is given by
...
To consider \textbf{multiple} \textit{plays} case, we reformulate the derivation as follows:
...
% and
\begin{equation}
y_{j} = \frac{1}{K} \sum_{k=1}^{K} y_{j}^{k}
\end{equation}
