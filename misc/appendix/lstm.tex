\section{Gradients of LSTM architectures with respect to inputs}
Considering $x_n \in \mathbb{R}$, the LSTM unit is simplified as follows,
\begin{eqnarray}
...
\begin{align*}
    ...
    o_{n} \frac{\partial a_{n}}{\partial C_{n}} \left(C_{n-1} \frac{\partial f_{n}}{\partial x_{n}} + \frac{\partial i_{n}}{\partial x_{n}} \tilde{C}_n + i_{n}\frac{\partial \tilde{C_{n}}}{\partial x_{n}}\right) \\
    &=  a_{n} \frac{\partial o_{n}}{\partial z_{n}} \frac{\partial z_{n}}{\partial x_{n}} + 
    o_{n} \frac{\partial a_{n}}{\partial C_{n}} \left( C_{n-1} \frac{\partial f_{n}}{\partial s_{n}} \frac{\partial s_{n}}{\partial x_{n}} + \frac{\partial i_{n}}{\partial r_{n}}\frac{\partial r_{n}}{\partial x_{n}} \tilde{C}_n + i_{n}\frac{\partial \tilde{C_{n}}}{\partial u_{n}}\frac{\partial u_{n}}{\partial x_{n}} \right) \\
    \begin{split}
...
where
  \begin{eqnarray*}
    %\begin{aligned}
      z_n &=& w_o x_n + w_{ro} h_{n-1} + b_o \\ 
      s_n &=& w_f x_n + w_{rf} h_{n-1} + b_f \\
      r_n &=& w_i x_n + w_{ri} h_{n-1} + b_i \\
      u_n &=& w_c x_n + w_{rc} h_{n-1} + b_c
    %\end{aligned}
  \end{eqnarray*}
...
\end{eqnarray*}
where $y_n = \sum_{i=0}^{U} \theta_i h_{n}^{(i)}$ and $\theta_i$ is the coefficient of dense layer.
\FloatBarrier