...
A recurrent neural network (RNN) is an extension of a conventional feed-forward neural network that can handle arbitrary-length sequence inputs. The RNN allows previous outputs to be used as inputs while having internal hidden states.
