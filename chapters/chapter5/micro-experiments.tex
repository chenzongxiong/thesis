...
Before we compare the performance of HNN with other recurrent networks, we confirm that the effects of HNN's initial states can be ignored if we have large enough data sets. 
...
\begin{figure}[h!]
    ...
    \caption{Different initial states for set $D$ and $P$ on test set}
