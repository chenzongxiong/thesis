...
In this chapter, we evaluate the performance of LSTM/SimpleRNN/GRU networks (see \myappendixsectionref{sec:appendix:rnn}) and HNN with two different data sets $D$ and $P$, which are generated from ground-truth networks with $\#nb\_plays=50$ and $\#units = 50$ (see \mytableref{tbl:chapter5:hyperparameters}). 
...
\begin{equation*}
    {\#parameters} = 4 * ({{\#\_\_units\_\_}}^2 + 2*{\#\_\_units\_\_}) + {\#\_\_units\_\_} + 1
\end{equation*}
...
\begin{equation*}
   {\#parameters} = ({{\#\_\_units\_\_}}^2 + 2*{\#\_\_units\_\_}) + {\#\_\_units\_\_} + 1    
\end{equation*}
and
\begin{equation*}
   {\#parameters} = 3 * ({{\#\_\_units\_\_}}^2 + 2*{\#\_\_units\_\_}) + {\#\_\_units\_\_} + 1    
\end{equation*}
 respectively.
...
\begin{equation*}
    {\#parameters} = 3 * {\#\_\_plays\_\_} * {\#\_\_units\_\_} + 1
\end{equation*}
