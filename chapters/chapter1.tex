...
\begin{figure}[htb!]
    ...
    \caption{The overall predictive outputs against ground-truth outputs for two different sequences in \myfigref{fig:chapter1:hnn-lstm-result-1} and \myfigref{fig:chapter1:hnn-lstm-result-2} (see \ref{cha:chapter5} for details)}
...
\begin{figure}[htb!]
    ...
    \caption{The overall predictive outputs against ground-truth outputs for LSTM and HNN in \myfigref{fig:chapter1:market-lstm-result} and \myfigref{fig:chapter1:market-hnn-result} (see \mysectionref{sec:chapter5:synthetic-data-sets} for details)}
