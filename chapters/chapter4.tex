...
In this chapter, we introduce a method to train the market model described in \mychapterref{cha:chapter3} using HNN.  
% and using HNN to train our market model and do prediction.
