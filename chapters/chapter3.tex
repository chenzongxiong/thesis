\chapter{Financial Market Model\label{cha:chapter3}}s
...
In this chapter, we show our financial market model based on hysteresis operators in details and provide a practical way to generate synthetic data from this model.
...
According to \myremarkref{remark:chapter3:practical-analysis}, we introduce two auxiliary concepts of agents, \textit{real agents N} and \textit{real agents D}, and suggest the following general practical approach to generate synthetic data sets for our market model.
...
\item Why should we assume that the amount of wealth belonged to people is followed by gamma distribution ? \\
    According to \citep{wiki:pareto-distribution}, it makes sense that only a few people possess a large volume of wealth in reality. One of advantages using gamma distribution instead of pareto distribution is that gamma distribution is continuous. And we can tune the shape of gamma distribution to approximate pareto distribution.
...
\begin{figure}[htb!]
    ...
    %\subfloat[]{
        %\raisebox{0px} {
            ...
            \includegraphics[width=\textwidth/2]{market-real-agents-n-distribution}\label{fig:chapter3:market-real-agents-n-distribution}
            \includegraphics[width=\textwidth/2]{market-virtual-agents-d-distribution}\label{fig:chapter3:market-virtual-agents-d-distribution}
    ...
    %     \subfloat[]{
            ...
            \includegraphics[width=\textwidth/2]{market-real-agents-alpha-distribution}\label{fig:chapter3:market-real-agents-alpha-distribution}
...
\begin{figure}[t!]
    \centering
    \subfloat[]{
    \includegraphics[width=\textwidth]{market-participanted-agents}
    }
...
\begin{figure}[t!]
    \centering
    \subfloat[]{
        \includegraphics[width=\textwidth]{market-ground-truth-dataset}
    }
