...
\mytodo{In this chapter, we show our financial market model based on hysteresis operators and provide a practical way to generate synthetic data to simulate this model.}
...
\mytodo{show that both agents N and D taking part in the simulation}
\begin{figure}
    \centering
    \subfloat[]{
        \includegraphics[width=\textwidth]{market-real-agents-n-distribution}
    }
    \subfloat[]{
            \includegraphics[width=\textwidth]{market-real-agents-alpha-distribution}
    }
    \hfill
    \subfloat[]{
            \includegraphics[width=\textwidth]{market-virtual-agents-d-distribution}
    }
    \subfloat[]{
            \includegraphics[width=\textwidth]{market-virtual-agents-n-distribution}
    }
