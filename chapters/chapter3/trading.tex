% \section{Trading\label{sec:chapter3:trading}}

% \subsection{Dima's model assumptions}
% \label{sec:chapter3:assumption}
...
% \label{sec:chapter3:direct_learning}
...
% \subsection{How to determine undetermined direction of random walk ?}
