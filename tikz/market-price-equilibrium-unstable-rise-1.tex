...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        % \node[below][xshift=5pt,yshift=-5pt] (xn) at (1.3, 0) {$x^{intermediate}_n$};
        \node[below][xshift=5pt,yshift=-5pt] (xn1) at (0.3,0.05) {$x^{2}_n$};
        % \node[below][xshift=5pt,yshift=-5pt] (xn2) at (1.3, 0) {$x^{1}_n$};
        ...
        \addplot[->,line width=1.1,color=blue][xshift=5pt,yshift=-5pt] coordinates {(0.3, 0.36)  (0.7, 0.84)};
        \addplot[->,line width=1.1,color=red][xshift=5pt,yshift=-5pt] coordinates {(0.3, 0.64)  (0.7, 0.96)};
