...
\pgfplotstableread[col sep=comma]{sorted-stock-rmse.csv}\mydata
...
\begin{axis}[
    ...
    \addplot[color=red,mark=.] table[x index={0}, y index={6}]{\mydata}; % ground truth

    \addplot+[color=blue,mark=., name path=higher] table[x index={0}, y index={7}]{\mydata}; 
