...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        \addplot+[color=black, dashed, ->, mark=none, domain=-1.3:-1.5] {-1};
        \addplot+[color=black, solid, ->, mark=none, domain=-2:-1.3] {-1};
        \addplot+[color=black, solid, ->, mark=none, domain=-2:-0.3] {-1};
        \addplot+[color=black, solid, mark=none, domain=-0.3:1] {-1};

        \addplot+[color=black, solid, mark=none, ->,domain=1.3:1.5] {+1};
        ...
        \draw[color=black, solid, mark=none] (1, -0.2) -- (1, +1);
