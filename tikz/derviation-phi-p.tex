...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        \addplot+[line width=1pt, mark=none, color=blue, domain=-2:-0.5] {-1};
        \addplot+[line width=1pt, mark=none, color=blue, domain=-0.5:0.5] {0};
        \addplot+[line width=1pt, mark=none, color=blue, domain=0.5:2] {-1};
        \end{axis}
    \end{tikzpicture}
