...
\begin{groupplot}[    
    ...
    \nextgroupplot[ylabel=Kn]
    \addplot[color=red,mark=*] table[x index={6}, y index={3}]{\mydata}; % random walk
    \nextgroupplot[ylabel=price]
    \addplot[color=blue,mark=*] table[x index={6}, y index={2}]{\mydata}; % price
    \nextgroupplot[ylabel=stocks]
    \addplot[color=black,mark=*] table[x index={6}, y index={0}]{\mydata}; % stocks
