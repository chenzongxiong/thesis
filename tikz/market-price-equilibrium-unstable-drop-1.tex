...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        \addplot+[mark=none, line width=1.1, color=blue, domain=0.1:1.9][xshift=5pt,yshift=-5pt] {0.8*x + 0.4};
        
        \addplot+[mark=none, line width=1.1, color=red, domain=0.1:1.6][xshift=5pt,yshift=-5pt] {1.2*x};
        
        % \addlegendentry{$k=1$}
        
         \node[left][xshift=5pt,yshift=-5pt] (A) at (0.3, 0.36) {A};
        % \node[below] (C) at (1.7, 1.76) {C};
        
        \node[above][xshift=5pt,yshift=-5pt] (B) at (1, 1.2) {B};
         \node[above][xshift=5pt,yshift=-5pt] (C) at (0.3, 0.64) {C};
        %\node[above] (A) at (1.4, 1.68) {A};
        \node[below][xshift=5pt,yshift=-5pt] (xn) at (0.3, 0.03) {$x^{2}_n$};
        ...
        \addplot[->,line width=1.1,color=red][xshift=5pt,yshift=-5pt] coordinates {(1, 1.2) (0.7, 0.84)};
        \addplot[->,line width=1.1,color=blue][xshift=5pt,yshift=-5pt] coordinates {(1, 1.2)  (0.7, 0.96)};

        \addplot[dashed,line width=1, color=black][xshift=5pt,yshift=-5pt] coordinates {(1, 1.2)  (1,0)};
        \addplot[dashed,line width=1, color=black][xshift=5pt,yshift=-5pt] coordinates {(0.3,0.64)  (0.3,0)};
