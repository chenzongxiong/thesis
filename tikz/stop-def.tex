...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        \addplot+[solid, mark=none, color=black, domain=-2.2:2.2] {+1};
        \addplot+[solid, mark=none, color=black, domain=-2.2:2.2] {-1};
        
        \addplot+[solid, mark=none, color=black, domain=0:0.5, ->, line width=1.5pt] {x};
        \addplot+[solid, mark=none, color=black, domain=0.5:1, line width=1.5pt] {x};

        \addplot+[solid, mark=none, color=black, domain=1:1.3, ->, line width=1.5pt] {1};
        \addplot+[solid, mark=none, color=black, domain=1.3:1.6, line width=1.5pt] {1};
        
        \addplot+[solid, mark=none, color=black, domain=1.6:0.4, ->, line width=1.5pt] {x-0.6};
        \addplot+[solid, mark=none, color=black, domain=0.4:-0.4, line width=1.5pt] {x-0.6};

        \addplot+[solid, mark=none, color=black, domain=-0.4:-1, ->, line width=1.5pt] {-1};
        \addplot+[solid, mark=none, color=black, domain=-1:-2, line width=1.5pt] {-1};

        \addplot+[solid, mark=none, color=black, domain=-2:-1, ->, line width=1.5pt] {x+1};
        \addplot+[solid, mark=none, color=black, domain=-1:0, line width=1.5pt] {x+1};

        
        \addplot+[solid, mark=none, color=black, domain=0:0.5, ->, line width=1.5pt] {1};
        \node[below] at (0.7,0){$r$};
        \node[above] at (-1.2, 0){$-r$};
        \node[below] at (1.6,0) {$A$};
        \node[above] at (-2,0) {$-A$};
        \draw[dashed] (-2,0) -- (-2,-1);
        \draw[dashed] (1.6,0) -- (1.6,1);
