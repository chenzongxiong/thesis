...
%% p indicates the the float is allowed to go on a float page or column area
    ...
    \begin{tikzpicture}
        ...
        \node[below][xshift=5pt,yshift=-5pt] (xn) at (1.5, 0.03) {$x^{1}_n$};
        \node[below][xshift=5pt,yshift=-5pt] (xn) at (1, 0)     {$x_n$};
        
        % \node[below] (A) at (0.3, 0.36) {A};
        % \node[above] (B) at (1, 1.2) {B};
        % \node[above] (C) at (0.3, 0.64) {C};
        % \node[below] (xn) at (1.3, 0) {$x^{intermediate}_n$};

        % \node[below] (PD) at (1.7, 1.76) {$P_D$};
        % \node[above] (PN) at (1.4, 1.68) {$P_N$};

        \addplot[->,line width=1.1,color=blue][xshift=5pt,yshift=-5pt] coordinates {(1, 1.2)  (1.3, 1.44)};
        \addplot[->,line width=1.1,color=red][xshift=5pt,yshift=-5pt] coordinates {(1, 1.2)  (1.3, 1.56)};
