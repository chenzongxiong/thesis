...
\pgfplotstableread[col sep=comma]{analysis-hnn-lstm.csv}\mydata
...
\begin{groupplot}[    
    ...
    \addplot[color=red,dashed, mark=.] table[x index={0}, y index={3}]{\mydata}; % lstm results
    \addplot[color=green,dashdotted, mark=.] table[x index={0}, y index={4}]{\mydata}; % hnn results
